...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-emerald-900">
      ...
      <section className="px-4 py-12 sm:py-16 bg-slate-800/50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-slate-900 rounded-2xl border border-slate-700 p-6 sm:p-8 max-w-4xl mx-auto">
      ...
      <section className="px-4 py-12 sm:py-16">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-lg sm:text-xl text-slate-300">Four simple steps to automated trading success</p>
          </div>
      ...
      <section className="px-4 py-12 sm:py-16 bg-slate-800/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4">Why Join the Waitlist?</h2>
            <p className="text-lg sm:text-xl text-slate-300">Choose your path to AI powered trading</p>
          </div>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto">
            {/* Free Plan */}
            <div className={`bg-slate-900 border-2 rounded-2xl p-6 sm:p-8 relative transition-all ${
            ...
            {/* Beta Plan */}
            <div className={`bg-gradient-to-br from-emerald-900/50 to-emerald-800/50 border-2 rounded-2xl p-6 sm:p-8 relative transition-all ${
              ...
              <div className="text-center mb-6">
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-2">Beta Access</h3>
      ...
      <section className="px-4 py-12 sm:py-16">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4">Features That Sell the Vision</h2>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center">
              <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-6 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center">
                <Brain className="h-8 w-8 sm:h-10 sm:w-10 text-white" />
              </div>
              <h3 className="text-lg sm:text-xl font-semibold text-white mb-3">🧠 AI Brain Driven Decisions</h3>
              <p className="text-slate-300">Pipnosis evaluates every trade in real time based on smart predictions.</p>
            </div>
            
            <div className="text-center">
              <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-6 bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl flex items-center justify-center">
                <Camera className="h-8 w-8 sm:h-10 sm:w-10 text-white" />
              </div>
              <h3 className="text-lg sm:text-xl font-semibold text-white mb-3">📷 Snapshot OR API Mode</h3>
              <p className="text-slate-300">Use chart screenshots or connect your MT5 account with one click.</p>
            </div>
            
            <div className="text-center">
              <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-6 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl flex items-center justify-center">
                <Target className="h-8 w-8 sm:h-10 sm:w-10 text-white" />
              </div>
              <h3 className="text-lg sm:text-xl font-semibold text-white mb-3">📈 Set Your Goals, Sit Back</h3>
      ...
      <section className="px-4 py-12 sm:py-16 bg-slate-800/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4">What Users Say</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto">
            <div className="bg-slate-900 border border-slate-700 rounded-2xl p-6 sm:p-8">
              ...
              <blockquote className="text-slate-300 text-base sm:text-lg mb-4 italic">
