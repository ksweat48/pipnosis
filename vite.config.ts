...
export default defineConfig({
  ...
  server: {
    ...
    headers: {
      ...
      'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' data: https://fonts.gstatic.com; img-src 'self' data: https: blob:; connect-src 'self' http://localhost:* ws://localhost:* wss://localhost:* https://*.supabase.co wss://*.supabase.co https://*.metaapi.cloud wss://*.metaapi.cloud https://mt-provisioning-api-v1.new-york.metaapi.cloud https://mt-provisioning-api-v1.london.metaapi.cloud https://mt-provisioning-api-v1.singapore.metaapi.cloud https://mt-client-api-v1.new-york.metaapi.cloud https://mt-client-api-v1.london.metaapi.cloud https://mt-client-api-v1.singapore.metaapi.cloud https://*.agiliumtrade.ai wss://*.agiliumtrade.ai https://mt-provisioning-api-v1.agiliumtrade.agiliumtrade.ai https://mt-client-api-v1.agiliumtrade.agiliumtrade.ai https://api.openai.com; worker-src 'self' blob:; child-src 'self' blob:;"
    },
    hmr: {
      overlay: true,
      clientPort: 5173
