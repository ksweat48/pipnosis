...
-- ============================================================================
-- This applies ALL remaining missing tables identified from your database
...
-- Missing from AI Training & Backtesting
...
-- Missing from Pattern Clustering
...
-- Missing from Strategy Discovery
...
-- Missing from Auto Backtest System
...
-- Policies for ai_strategy_performance
...
CREATE POLICY "Authenticated users view strategy performance"
  ON ai_strategy_performance FOR SELECT
  TO authenticated
  USING (true);
...
CREATE POLICY "System can insert strategy performance"
  ON ai_strategy_performance FOR INSERT
  TO authenticated
  WITH CHECK (true);

-- Policies for strategy_analytics
...
CREATE POLICY "System manages backtests"
  ON auto_backtest_controller FOR ALL
  TO authenticated
  USING (true)
  WITH CHECK (true);
...
BEGIN
  RAISE NOTICE '============================================================';
  RAISE NOTICE 'ALL REMAINING MIGRATIONS APPLIED SUCCESSFULLY';
  RAISE NOTICE '============================================================';
  RAISE NOTICE 'Tables created:';
  RAISE NOTICE '  ✓ ai_strategy_performance';
  RAISE NOTICE '  ✓ strategy_analytics';
  RAISE NOTICE '  ✓ user_performance_summary';
  RAISE NOTICE '  ✓ ai_training_scenarios';
  RAISE NOTICE '  ✓ pattern_clusters';
  RAISE NOTICE '  ✓ strategy_discovery';
  RAISE NOTICE '  ✓ auto_backtest_controller';
  RAISE NOTICE '============================================================';
END $$;
