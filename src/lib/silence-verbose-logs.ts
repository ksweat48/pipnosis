...
logger.setCategoryLevel(LogCategory.CHART_POLLER, isDev ? LogLevel.DEBUG : LogLevel.SILENT);
...
logger.setCategoryLevel(LogCategory.CHART, isDev ? LogLevel.DEBUG : LogLevel.WARN);
logger.setCategoryLevel(LogCategory.CHART_INIT, isDev ? LogLevel.DEBUG : LogLevel.WARN);
