      ...
      {!isConnected && !isChecking && (
        <div className="mt-3 p-2 bg-red-500/10 border border-red-500/30 rounded text-xs text-red-300">
          <div className="flex items-start space-x-2">
            ...
            <div>
              <p className="font-medium">MT5 bridge not connected at {currentCredentials?.bridgeHost || 'your IP'}:{currentCredentials?.bridgePort || '8765'}</p>
              ...
              <p className="mt-1">If using a public IP, verify port forwarding is set up correctly.</p>
            </div>
          </div>
        </div>
      )}
