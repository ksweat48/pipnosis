...
import { TrendingUp, Shield, ArrowRight, Clock, X } from 'lucide-react';
...
export const TP1DecisionModal: React.FC<TP1DecisionModalProps> = ({
  ...
  useEffect(() => {
    if (countdown === 0 && isOpen && !hasAutoActedRef.current && !isProcessing) {
      ...
      console.log('[TP1DecisionModal] Timeout reached - auto-continuing to TP2');
      onContinueToTP2();
    }
  }, [countdown, isOpen, isProcessing, onContinueToTP2]);
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-md animate-in zoom-in-95 duration-300">
        <div className="absolute -inset-px bg-gradient-to-r from-amber-500 to-emerald-500 rounded-2xl opacity-50 blur-lg" />

        <div
          className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl border border-amber-500/40 shadow-2xl overflow-hidden flex flex-col"
          ...
          <div className="overflow-y-auto flex-1" style={{ WebkitOverflowScrolling: 'touch' }}>
            ...
            <div className="relative pt-5 pb-4 px-5">
              ...
              <div className="relative flex items-center gap-3 pr-8">
                <div className="p-2.5 bg-gradient-to-br from-amber-500 to-orange-500 rounded-xl shadow-md shrink-0">
                  <TrendingUp className="w-5 h-5 text-white" />
                </div>
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-0.5">
                    <span className="text-xs font-bold text-amber-400 uppercase tracking-wider">TP1 Hit</span>
                  ...
                  <h2 className="text-base font-bold text-white leading-tight">
                    {data.symbol} — Take Profit 1 Reached
                  </h2>
                </div>
              </div>
            </div>
