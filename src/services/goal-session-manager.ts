  ...
  async handleGoalAchievementAction(
    ...
    try {
      ...
      switch (action) {
        ...
        case 'continue_to_tp':
          // User chose to continue - trade continues unchanged
          console.log(`[Goal Session] User chose to continue to TP for session ${goalSessionId}`);
          return { success: true, message: 'Trade will continue to Take Profit' };
