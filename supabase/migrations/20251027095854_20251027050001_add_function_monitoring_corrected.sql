/*
  # Add Function Monitoring Tables (Corrected)
  ...
  2. Security
    ...
    - Add policies for admin users to read monitoring data (using is_admin column)
...
-- Create policies for function_execution_logs (CORRECTED to use is_admin)
...
-- Create policies for function_health_metrics (CORRECTED to use is_admin)
