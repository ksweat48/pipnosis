...
CREATE TABLE IF NOT EXISTS ai_market_scenario_performance (
  ...
  market_type text NOT NULL CHECK (market_type IN ('trending_up', 'trending_down', 'ranging', 'high_volatility', 'low_volatility', 'breakout', 'reversal', 'mixed')),
  symbol text NOT NULL,
  timeframe text NOT NULL,
