/*
  # Fix Trigger Issue Migration

  1. Changes
    - Safely drop existing triggers before recreating them
    - Use DO blocks with exception handling to prevent errors
    - Add IF NOT EXISTS checks for all operations
    - Fix the update_updated_at_column function if needed
...
-- Add any other triggers that need to be fixed
