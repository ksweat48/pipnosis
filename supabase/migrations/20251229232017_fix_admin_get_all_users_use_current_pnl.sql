/*
  # Fix admin_get_all_users - Use Correct PnL Column

  ## Problem
  - Function references non-existent `unrealized_pnl` column
  - Actual column name is `current_pnl`

  ## Solution
  - Update function to use `current_pnl` instead of `unrealized_pnl`

  ## Changes
  - Replace `gst.unrealized_pnl` with `gst.current_pnl`
*/
