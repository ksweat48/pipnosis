/*
  # Remove Waitlist Table and Functionality
  
  This migration safely removes the waitlist table and all associated policies
  without affecting other tables or functionality.
