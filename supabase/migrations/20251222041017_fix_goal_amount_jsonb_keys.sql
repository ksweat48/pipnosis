/*
  # Fix JSONB Keys for Frontend Compatibility

  ## Problem
  The previous migration fixed the SQL column reference (target_value)
  but the JSONB keys in modal_data still use 'target_value'.
  The frontend expects 'goal_amount' in the JSONB data.

  ## Solution
  Update the JSONB keys to use 'goal_amount' for frontend compatibility
  while keeping the SQL column reference as 'target_value'.
*/

-- ============================================================================
-- Fix trigger_continuation_modal - Use goal_amount in JSONB
-- ============================================================================
...
BEGIN
  ...
  -- Create persistent modal record (use goal_amount key for frontend)
  ...
  -- Create notification record (use goal_amount key for frontend)
...
-- ============================================================================
-- Fix create_session_ended_modal - Use goal_amount in JSONB
-- ============================================================================
...
BEGIN
  ...
  -- Create persistent session_ended modal (use goal_amount key for frontend)
  INSERT INTO pending_user_modals (
    user_id,
    goal_session_id,
    modal_type,
