/*
  # Fix admin_get_all_users - Credit Balance Column Reference

  1. Problem:
    - Function was referencing up.credit_balance which doesn't exist
    - Credit balance is stored in user_token_balance table, not user_profiles
    
  2. Solution:
    - Join with user_token_balance table to get credit balance
    - Use COALESCE to handle users without token balance records
