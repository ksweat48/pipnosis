/*
  # Add market_analysis table for AI technical analysis
  ...
  ## Helper Functions
  - get_latest_market_analysis() - Get most recent analysis for symbol/timeframe
  - get_valid_trade_signals() - Get all valid trade signals from last hour
*/
...
DROP POLICY IF EXISTS "Anyone can read market analysis" ON market_analysis;
DROP POLICY IF EXISTS "Authenticated users can insert market analysis" ON market_analysis;
DROP POLICY IF EXISTS "Authenticated users can update market analysis" ON market_analysis;
