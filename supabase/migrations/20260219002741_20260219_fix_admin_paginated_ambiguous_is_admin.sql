/*
  # Fix ambiguous is_admin column in admin_get_all_users_paginated

  The new lateral subquery joining goal_sessions caused "is_admin" to become
  ambiguous. Fully qualify it as up.is_admin in the SELECT.
*/
