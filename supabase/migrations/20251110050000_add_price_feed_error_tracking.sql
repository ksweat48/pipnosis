/*
  ...
  ## Overview
  Creates a comprehensive error tracking system for price feed failures.
  Helps identify MetaAPI connection issues and data quality problems.
  ...
  ## Features
  - Error categorization (connection, auth, timeout, rate_limit, etc)
  - Detailed error messages and stack traces
  - Automatic cleanup of old errors (older than 7 days)
  - Performance indexes for error analysis queries

  ## Security
  - RLS enabled
  - Authenticated users can read errors
  - Service role can write errors
*/
...
CREATE POLICY "Service role can write price feed errors"
  ON price_feed_errors
  FOR INSERT
  TO service_role
  WITH CHECK (true);
