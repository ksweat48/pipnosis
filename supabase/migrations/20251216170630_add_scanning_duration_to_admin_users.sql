/*
  # Add Scanning Duration to Admin User Management
  
  ## Changes
  - Update admin_get_all_users() to return scanning duration in minutes
  - Show how long each user has been scanning for active sessions
  
  ## Details
  - Returns NULL if not scanning
  - Returns minutes elapsed since scanning_session_started_at or start_time
*/
