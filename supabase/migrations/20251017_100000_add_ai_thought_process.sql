/*
  ...
  The thought process entries are created as the AI analyzes a trade request:
  - Symbol scanning phase
  - Market data analysis
  - FxFlow strategy evaluation
...
-- Users can view their own thought process entries
