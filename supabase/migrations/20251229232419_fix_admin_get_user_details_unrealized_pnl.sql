/*
  # Fix admin_get_user_details Function

  ## Problem
  - Function references `unrealized_pnl` which doesn't exist
  - Actual column is `current_pnl` in goal_session_trades

  ## Solution
  - Replace `unrealized_pnl` with `current_pnl`
*/
...
BEGIN
  ...
  -- Get active trades (FIX: use current_pnl instead of unrealized_pnl)
